...
def main():
    ...
    parser.add_argument(
        "--repo-id", type=str, required=True, help="HF repo ID (e.g., user/baligh-1.5b-v0-instruct)"
    )
    parser.add_argument("--token", type=str, help="HF token")
    parser.add_argument("--private", action="store_true", help="Make repo private")
    parser.add_argument(
        "--commit-message", type=str, default="Release Baligh-1.5B v0", help="Commit message"
    )
